                  ...
                  <div class="notification-card">
                    ...
                    <div class="notification-body">
                      <a href="#" class="notification-list">
                        ...
                        <p>Notificación 1</p>
                        <span class="time">hace X horas</span>
                      </a>
                      <a href="#" class="notification-list">
                        <i class="fas fa-bolt"></i>
                        <p>Notificación 2</p>
            ...
            <nav class="navbar navbar-expand-lg cp-nav-2">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                  ...
                  <li class="menu-item active"><a title="Home" href="../home-1.html">INICIO</a></li>
                  <li class="menu-item dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">GRUPOS</a>
                    <ul  class="dropdown-menu">
					  <li class="menu-item"><a  href="#">VER</a></li>
                      <li class="menu-item"><a  href="#">CREAR</a></li>
                      <li class="menu-item"><a  href="#">MODIFICAR</a></li>
                      <li class="menu-item"><a  href="#">ELIMINAR</a></li>
                      <!-- <li class="menu-item"><a  href="post-job.html">Post Job</a></li> -->
                    </ul>
                  </li>
                  <li class="menu-item dropdown">
                    <a title="" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">PRODUCTOS</a>
                    <ul  class="dropdown-menu">
                      <li class="menu-item"><a  href="#">VER</a></li>
                      <li class="menu-item"><a  href="#">CREAR</a></li>
                      <li class="menu-item"><a  href="#">MODIFICAR</a></li>
                ...
                <!--   <li class="menu-item dropdown">
                  ...
                  <li class="menu-item dropdown">
                    <a title="" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">REPORTES</a>
                    <ul  class="dropdown-menu">
                      <li class="menu-item"><a href="../about-us.html">POR FECHA</a></li>
                      <li class="menu-item"><a href="../how-it-work.html">MES</a></li>
                      <li class="menu-item"><a href="../pricing.html">AÑO</a></li>
                      <li class="menu-item"><a href="../faq.html">ESPECIFICA</a></li>
                     <!-- <li class="menu-item dropdown">
                  ...
                  <li class="menu-item"><a href="../contact.html">ASIGNACIONES</a></li>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="breadcrumb-area">
              <h1>Invetario Dashboard</h1>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Inventario Dashboard</li>
                </ol>
              </nav>
            </div>
          </div>
              ...
              <div class="dashboard-content-wrapper">
                ...
                <div class="dashboard-section dashboard-recent-activity">
                  ...
                  <div class="activity-list">
                    ...
                    <div class="content">
                      <h5>Actividad histórica 2!</h5>
                      <span class="time">horario 2</span>
                    </div>
                    <div class="close-activity">
                      <i class="fas fa-times"></i>
                    </div>
                  ...
                  <div class="activity-list">
                    ...
                    <div class="content">
                      <h5>Actividad histórica 3!</h5>
                      <span class="time">horario 3</span>
                    </div>
                    <div class="close-activity">
                      <i class="fas fa-times"></i>
                    </div>
                  ...
                  <div class="activity-list">
                    <i class="fas fa-check-square"></i>
                    <div class="content">
                      <h5>Actividad histórica 4!</h5>
                      <span class="time">horario 4</span>
                    </div>
                    <div class="close-activity">
                      <i class="fas fa-times"></i>
                    </div>
              ...
              <div class="dashboard-sidebar">
                ...
                <div class="dashboard-menu">
                  <ul>
                    ...
                    <li><i class="fas fa-user"></i><a href="#">Menu 1</a></li>
                    <li><i class="fas fa-file-alt"></i><a href="#">Menu 2</a></li>
                    <li><i class="fas fa-edit"></i><a href="#">Menu 3</a></li>
                    <li><i class="fas fa-heart"></i><a href="#">Menu 4</a></li>
                    <li><i class="fas fa-check-square"></i><a href="#">Menu 5</a></li>
                    <li><i class="fas fa-comment"></i><a href="#">Menu 6</a></li>
                    <li><i class="fas fa-calculator"></i><a href="#">Menu 7</a></li>
                  </ul>
                  <ul class="delete">
                ...
                <div class="row">
                 <!-- <div class="col-xl-4 col-lg-5 order-lg-2">
                  ...
                  <div class="col-xl-4 col-lg-4 order-lg-1">
                    <p class="copyright-text">Copyright <a href="#">INTECPROOF</a> 2024</p>
                  </div>
