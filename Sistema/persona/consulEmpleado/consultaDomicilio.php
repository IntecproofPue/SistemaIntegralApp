              ...
              <form action="altaPersona" method="post" class="dashboard-form">
                <div class="dashboard-section basic-info-input">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>ENTIDAD FEDERATIVA:</span>INGRESA ENTIDAD EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>MUNICIPIO:</span>INGRESA MUNICIPIO EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>LOCALIDAD:</span>INGRESA LOCALIDAD EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>C.P.:</span>INGRESA CP EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>COLONIA:</span>INGRESA COL EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>CALLE:</span>INGRESA CALLE EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>No. EXTERIOR:</span>INGRESA No EXT EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <ul>
                        <li><span>No. INTERIOR:</span>INGRESA INT EMPLEADO</li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      ...
                      <button type="button" class="button"
                        onclick="window.location.href = '#'">CONTINUAR</button>
                    </div>
                  </div>
                </div>
              </form>
