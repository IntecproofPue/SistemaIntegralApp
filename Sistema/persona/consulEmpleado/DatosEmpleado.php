        ...
        <div class="row no-gliters">
            <div class="col">
                <div class="dashboard-container">
                        ...
                        <form class="dashboard-form" id="FormResultadoConsulta">
                            ...
                            <div class="dashboard-section basic-info-input">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <li class="campo-item" id="mostrarPrimerApellido"></li>
                                    </div>
                                </div>
                                <div class="form-group row">
                    ...
                    <script>
                        let datosEmpleadoRecuperados = JSON.parse(localStorage.getItem('datosConsultaIndividual'));
                        if (datosEmpleadoRecuperados) {
                            document.getElementById('mostrarnombre').textContent = datosEmpleadoRecuperados.vchNombre;
                            document.getElementById('mostrarPrimerApellido').text = datosEmpleadoRecuperados.vchPrimerApellido;
                            document.getElementById('mostrarPrimerApellido').text = datosEmpleadoRecuperados.vchPrimerApellido;
                        }
                    </script>
                </div>
