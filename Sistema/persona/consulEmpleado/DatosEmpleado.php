                            ...
                            <script>
                                ...
                                document.addEventListener('DOMContentLoaded', function () {
                                    ...
                                    if (consultaIndivual) {
                                        ...
                                        vchRegimen.value = bResultado.vchRegimen || '';

                                        var vchUsoFiscal = document.getElementById('vchUsoFiscal');
                                        vchUsoFiscal.value = bResultado.vchUsoFiscal || '';

                                        var iCodigoPostalFiscal = document.getElementById('iCodigoPostalFiscal');
                                        iCodigoPostalFiscal.value = bResultado.iCodigoPostalFiscal || 0;
                            ...
                            <form action="#" method="post" class="dashboard-form">
                                <div class="dashboard-section basic-info-input">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="idInput" type="text" class="form-control" placeholder="ID" readonly />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="dashboard-section basic-info-input">
                                        <div class="row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-9">
                                                    <button class="button" href="../consultaDomicilio.php">CONTACTO</button>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label"></label>
                                                <div class="col-sm-9">
                                                    <button class="button" href="../consultaDomicilio.php">DOCUMENTOS</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
