        ...
        <div class="row">
            <div class="col-md-6">
                <div class="breadcrumb-area">
                    <h1><?= $consultaPersonaEmpleadotxt ?></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><?= $inicioTxt ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page">CONSULTA EMPLEADOS&nbsp;&nbsp;</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row no-gliters">
            <div class="col">
               ...
               Empleados.forEach(empleado => {
                   // Aquí puedes generar el HTML para cada empleado y añadirlo al DOM
                   // Por ejemplo, creando un nuevo div y añadiéndolo al DOM
                            ...
                            <div class='body'>
                                <div class='content'>
                                    ...
                                    <div class='info'>
                                        ...
                                        <!--<span class='location'><a href='#'><i data-feather='phone'></i>${empleado.vchNacionalidad}</a></span>-->
                                    </div>
                                </div>
                                <div class='button-area' id="buttonSiguiente">
               ...
               document.addEventListener('DOMContentLoaded', function(){
                   var botonSeleccionar = document.getElementById('buttonSiguiente');
                   botonSeleccionar.addEventListener('click', function(event){
