        ...
        <div class="col">
          ...
          <nav class="navbar navbar-expand-lg cp-nav-2">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                <li class="menu-item active"><a title="PERSONA" href="altaPersona.php">PERSONA</a>
              </li>
              ...
              if (isset($_POST['submitBuscar'])) {
                  ...
                  <form action="#" method="post" class="dashboard-form">
                    ...
                    <div class="dashboard-section basic-info-input">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>ID EMPLEADO:</span>INGRESA ID EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>NOMBRES EMPLEADO:</span>INGRESA NOMBRE(S) EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>PRIMER APELLIDO EMPLEADO:</span>INGRESA PRIMER APELLIDO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>SEGUNDO APELLIDO EMPLEADO:</span>INGRESA SEGUNDO APELLIDO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>PUESTO EMPLEADO:</span>INGRESA PUESTO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>FECHA DE INGRESO EMPLEADO:</span>INGRESA FECHA EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>ESTATUS EMPLEADO:</span>INGRESA ESTATUS EMPLEADO</li>
                          </ul>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>NSS EMPLEADO:</span>INGRESA NSS EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>FECHA DE ULTIMA PROMOCION EMPLEADO:</span>INGRESA FECHA PROMO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>SEDE EMPLEADO:</span>INGRESA SEDE EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>FECHA BAJA EMPLEADO:</span>INGRESA FECHA BAJA EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>USUARIO ULTIMA MODIFICACION:</span>INGRESA SUARIO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>DECHA DE MODIFICACION:</span>INGRESA MODIFICACION EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>RFC:</span>INGRESA RFC EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>CURP:</span>INGRESA CURP EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>FECHA DE NACIMIENTO:</span>INGRESA LA FECHA EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>GENERO:</span>INGRESA GENERO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>NACIONALIDAD:</span>INGRESA NACIONALIDAD EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>TIPO DE PERSONA:</span>INGRESA TIPO EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>REGIMEN FISCAL:</span>INGRESA REGIMEN EMPLEADO</li>
                          </ul>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <ul>
                            <li><span>USO FISCAL:</span>INGRESA USO FISCAL EMPLEADO</li>
                          </ul>
                        </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <ul>
                              <li><span>C.P. FISCAL:</span>INGRESA CP EMPLEADO</li>
                            </ul>
                          </div>
                        </div>
                ...
                ?>
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="dashboard-form">
                                  ...
                                  <div class="modal-body">
                                    <form action="#">
                                      <ul
                                        ...
                                        <li><span>SEDE:</span> MOSTRAR SEDE</li>
                                      </ul>
                          ...
                          <!--
                        <div id="resultadoDiv" class="dashboard-section basic-info-input" style="display: none;">
                          <h4><i data-feather="user-check"></i>RESULTADO DE BUSQUEDA</h4>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">SELECCIONAR CAMPO:</label>
                            <div class="job-summary">
                              <h4>TIPO DE EMPLEADO</h4>
                              <ul>
                                <li><span>ID DE EMPLEADO:</span> Oct 6, 2020</li>
                                <li><span>RFC:</span> 08</li>
                                <li><span>PUESTO:</span> Full-time</li>
                                <li><span>SEDE:</span> 2 to 3 year(s)</li>
                                <li><span>NOMBRE:</span> New ork City</li>
                              </ul>
                            </div>
                          </div>
                          <!-- Agrega aquí el resto del contenido de tu segundo div -->
                      </div>
