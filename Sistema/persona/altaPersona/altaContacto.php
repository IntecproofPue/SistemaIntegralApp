                            ...
                            <form action="altaPersona" method="post" class="dashboard-form">
                                ...
                                <div class="dashboard-section basic-info-input">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="button" class="button" onclick="agregarCampoContacto()">NUEVO
                                                CONTACTO</button>
                                            <button type="reset" class="button">LIMPIAR</button>
                                            <button type="button" class="button"
                                                onclick="window.location.href = 'altaEmpleado.php'">SIGUIENTE</button>
                                        </div>
                                    </div>
                                    <script>
                                        ...
                                        function agregarCampoContacto() {
                                            ...
                                            nuevoCampo.className = 'div class="form-group row';
